...
#PBS -j oe
#PBS -N ethanediol_4
#PBS -o /beegfs/work/st_163811/TAMie-force-field/example/pure_ethanediol/sim_4/LOG_ethanediol_4
#PBS -l mem=3000mb
...
v_dir=/beegfs/work/st_163811/TAMie-force-field/example/pure_ethanediol/sim_4
