...
#PBS -j oe
#PBS -N ethanediol_1
#PBS -o /beegfs/work/st_163811/TAMie-force-field/example/pure_ethanediol/sim_1/simulation/LOG_ethanediol_1
#PBS -l mem=3000mb
...
v_dir=/beegfs/work/st_163811/TAMie-force-field/example/pure_ethanediol/sim_1/simulation
